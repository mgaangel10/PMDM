...
import { StarwarsList } from 'src/app/modules/modules.module';

const StarWars_Response: StarwarsList={
  count: 60, 
...
export class PlanteListComponent {
  StarWars = StarWars_Response.results;
}
