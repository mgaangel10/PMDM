...
import{Result} from 'src/app/model/model.module';


const STARWARS:Result[]=[
...
VehiculosComponent=STARWARS;
src: string ="";
public urlGe(url: string){
  var urlP = url.split("/").reverse()[1];
  
  return "https://starwars-visualguide.com/assets/img/vehicles/"+urlP+".jpg";
}
