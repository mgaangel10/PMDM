...
class PokeDetailsResponse {
	...
	factory PokeDetailsResponse.fromMap(Map<String, dynamic> data) {
		return PokeDetailsResponse(
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [PokeDetailsResponse].
	factory PokeDetailsResponse.fromJson(String data) {
		return PokeDetailsResponse.fromMap(json.decode(data) as Map<String, dynamic>);
	}
  /// `dart:convert`
  ///
  /// Converts [PokeDetailsResponse] to a JSON string.
